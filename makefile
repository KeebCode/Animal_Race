# This is an example Makefile for a Hare and Tortoise Competition project.
# This program uses Hare, Tortoise, Road, and Competition modules.
...
HareTest: Hare.o HareTest.cpp
	$(CC) -c HareTest.cpp Hare.o
